...
<footer class="bg-section py-10">
            <div class="max-w-[1140px] mx-auto p-3">
                <div class="w-full m-auto sm:w-full">
                    <img src="public/images/lgo-1.png" alt="">
                    <p class="mt-3">Digital Sloution For Food Industry Success</p>
                </div>
                <div class="flex flex-wrap gap-7 sm:gap-16 mt-10">
                    <div class="flex-1">
                        <div class="flex gap-7 sm:gap-16 sm:flex-nowrap flex-wrap-reverse">
                            ...
                            <div class="flex-auto">
                                <div class="[&>*]:mb-5">
                                    <h4 class="text-SemiBold-md md:text-SemiBold text-primary">
                                        Flow Us
                                    </h4>
                                    <div class="block">
                                        <ul
                                            class="flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 [&>li]:h-7 [&>li>a_svg]:h-full [&>li>a_svg_*]:transition-all [&>li>a:hover_svg>rect]:stroke-secondary [&>li>a:hover_svg>path]:fill-secondary">
                                            <li>
                                                <a href="#">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"
                                                        fill="none">
                                                        <rect x="0.25" y="0.25" width="21.5" height="21.5" rx="4.75"
                                    ...
                                    <div class="mr-auto w-fit"><a class="flex gap-2 justify-center items-center"
                                    ...
                                    <p class="text-justify hidden sm:block">
                    ...
                    <div class="flex-1">
                        <h2 class="text-primary text-ExtraBold-md md:text-ExtraBold">Request a Demo</h2>
                        <p>Let’s Connect and Grow Together!</p>
                        <form
                            class="sm:bg-background rounded-lg mt-5 p-2 gap-2 flex flex-col sm:flex-row sm:justify-between items-stretch"
                            action="#">
                            <input class="flex-auto bg-background rounded-lg p-2" type="email" name="" id=""
                                placeholder="Enter you’re Email addres">
                            <button
                                class="py-2 px-6 rounded-lg bg-secondary w-max self-center flex items-center justify-between gap-2">
                                <span> Read More</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="13" viewBox="0 0 6 13"
                                    fill="none">
                                    <path
                                        d="M0.999999 12L3.55391 9.19069C4.71602 7.91237 5.29708 7.27321 5.29708 6.5C5.29708 5.72679 4.71602 5.08763 3.55392 3.80931L1 1"
    ...
    <svg class="w-0 h-0 invisible">
        <defs>
            <linearGradient id="sobelz_gradient_svg" x1="11.9824" y1="67.5323" x2="60.0176" y2="19.4971"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#E56B70" />
                <stop offset="1" stop-color="#AE070D" />
            </linearGradient>
        </defs>
    </svg>
